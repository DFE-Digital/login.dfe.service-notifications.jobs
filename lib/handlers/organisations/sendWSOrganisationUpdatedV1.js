const { getRepository, getOrgsDatabase } = require('./../../infrastructure/repository');
const SecureAccessWebServiceClient = require('./../../infrastructure/webServices/SecureAccessWebServiceClient');
const uuid = require('uuid/v4');

const clientCache = [];
const blockedTypes = ['09', '17', '22', '23', '27', '31', '37', '47', '48', '56', '98'];
...
const process = async (config, logger, application, data, jobId) => {
  ...
  try {
    ...
    orgs = getOrgsDatabase(config.database.organisations);
    ...
    if (!org || ~blockedTypes.indexOf(org.Type)) {
